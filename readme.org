...
*** useage
- auto-open tabs that you visit frequently, such as [[https://chatgpt.com]] or [[https://spotify.com]] in [[file:i3/config][i3 config]].  this allows you to hotkey to these sites using ~Alt+<number>~ consistently everytime.
