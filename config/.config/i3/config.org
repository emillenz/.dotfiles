...
bindsym $MOD+q            kill
bindsym $MOD+b            $SHCMD $BIN/window-menu
bindsym $MOD+Return       $SHCMD i3-dmenu-desktop --dmenu="dmenu $DMENU_THEME"
bindsym $MOD+shift+Return $SHCMD dmenu_run $DMENU_THEME
