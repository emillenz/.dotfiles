...
#+begin_src sh
dnf install zsh fd-find ripgrep tldr
...
#+begin_src sh
dnf install i3 wmctrl xdg-utils arandr mpv brightnessctl unclutter firefox playerctl bluetoothctl dunst alacritty feh maim xset xsetroot keepassxc scrot
...
#+begin_src sh
dnf install clojure
sh < <(curl -s https://raw.githubusercontent.com/babashka/babashka/master/install)
#+end_src
