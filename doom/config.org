...
- i don't believe in using variable pitch fonts.  i want a systemwide consistent font (in size and appearance) for all things: gui menus, displaying technical documents, source code, data (eg. terminal output), etc..
- only for prose might i use a serif font to become more immersed in the reading experience.
